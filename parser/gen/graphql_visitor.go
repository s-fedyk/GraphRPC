...
type GraphQLVisitor interface {
	...
	VisitExecutableDocument(ctx *ExecutableDocumentContext) interface{}
	...
	VisitTypeSystemDocument(ctx *TypeSystemDocumentContext) interface{}
	...
	VisitTypeSystemExtensionDocument(ctx *TypeSystemExtensionDocumentContext) interface{}
	...
	VisitExecutableDirectiveLocation(ctx *ExecutableDirectiveLocationContext) interface{}

	// Visit a parse tree produced by GraphQLParser#typeSystemDirectiveLocation.
	VisitTypeSystemDirectiveLocation(ctx *TypeSystemDirectiveLocationContext) interface{}
