...
// EnterExecutableDocument is called when production executableDocument is entered.
func (s *BaseGraphQLListener) EnterExecutableDocument(ctx *ExecutableDocumentContext) {}

// ExitExecutableDocument is called when production executableDocument is exited.
func (s *BaseGraphQLListener) ExitExecutableDocument(ctx *ExecutableDocumentContext) {}
...
// EnterTypeSystemDocument is called when production typeSystemDocument is entered.
func (s *BaseGraphQLListener) EnterTypeSystemDocument(ctx *TypeSystemDocumentContext) {}

// ExitTypeSystemDocument is called when production typeSystemDocument is exited.
func (s *BaseGraphQLListener) ExitTypeSystemDocument(ctx *TypeSystemDocumentContext) {}
...
// EnterTypeSystemExtensionDocument is called when production typeSystemExtensionDocument is entered.
func (s *BaseGraphQLListener) EnterTypeSystemExtensionDocument(ctx *TypeSystemExtensionDocumentContext) {
}

// ExitTypeSystemExtensionDocument is called when production typeSystemExtensionDocument is exited.
func (s *BaseGraphQLListener) ExitTypeSystemExtensionDocument(ctx *TypeSystemExtensionDocumentContext) {
}
