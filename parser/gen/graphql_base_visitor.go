...
func (v *BaseGraphQLVisitor) VisitExecutableDocument(ctx *ExecutableDocumentContext) interface{} {
	return v.VisitChildren(ctx)
}
...
func (v *BaseGraphQLVisitor) VisitTypeSystemDocument(ctx *TypeSystemDocumentContext) interface{} {
	return v.VisitChildren(ctx)
}
...
func (v *BaseGraphQLVisitor) VisitTypeSystemExtensionDocument(ctx *TypeSystemExtensionDocumentContext) interface{} {
	return v.VisitChildren(ctx)
}
...
func (v *BaseGraphQLVisitor) VisitExecutableDirectiveLocation(ctx *ExecutableDirectiveLocationContext) interface{} {
	return v.VisitChildren(ctx)
}

func (v *BaseGraphQLVisitor) VisitTypeSystemDirectiveLocation(ctx *TypeSystemDirectiveLocationContext) interface{} {
	return v.VisitChildren(ctx)
}
