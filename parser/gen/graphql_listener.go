...
type GraphQLListener interface {
	...
	// EnterExecutableDocument is called when entering the executableDocument production.
	EnterExecutableDocument(c *ExecutableDocumentContext)
	...
	// EnterTypeSystemDocument is called when entering the typeSystemDocument production.
	EnterTypeSystemDocument(c *TypeSystemDocumentContext)
	...
	// EnterTypeSystemExtensionDocument is called when entering the typeSystemExtensionDocument production.
	EnterTypeSystemExtensionDocument(c *TypeSystemExtensionDocumentContext)
	...
	// ExitExecutableDocument is called when exiting the executableDocument production.
	ExitExecutableDocument(c *ExecutableDocumentContext)
	...
	// ExitTypeSystemDocument is called when exiting the typeSystemDocument production.
	ExitTypeSystemDocument(c *TypeSystemDocumentContext)
	...
	// ExitTypeSystemExtensionDocument is called when exiting the typeSystemExtensionDocument production.
	ExitTypeSystemExtensionDocument(c *TypeSystemExtensionDocumentContext)
